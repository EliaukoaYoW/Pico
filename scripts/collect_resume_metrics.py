...
def build_arg_parser():
    ...
    parser.add_argument("--benchmark-artifact", default="artifacts/harness-regression-v2.json", help="Path to benchmark artifact JSON.")
    parser.add_argument("--runs-root", default=".pico/runs", help="Path to .pico/runs root.")
    ...
    parser.add_argument("--real-provider", choices=("gpt", "siliconflow"), default="siliconflow", help="Provider to use for real experiment mode.")
    ...
    parser.add_argument("--output-json", default="docs/metrics/resume_metrics.json", help="Path to output metrics JSON.")
    parser.add_argument("--output-markdown", default="docs/metrics/resume_metrics.md", help="Path to output metrics markdown.")
    return parser
